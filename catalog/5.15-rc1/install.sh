...
while [[ $# -gt 0 ]]; do
  ...
  case "${1}" in
    -amd|--amd64)
      ...
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/
      sudo dpkg -i *.deb
    ...
    -arm|--arm64)
      mkdir /tmp/ubuntukernel$KERNEL_VER
      cd /tmp/ubuntukernel$KERNEL_VER
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/arm64/linux-headers-5.15.0-051500rc1-generic_5.15.0-051500rc1.202109122030_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/arm64/linux-image-unsigned-5.15.0-051500rc1-generic_5.15.0-051500rc1.202109122030_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.15-rc1/arm64/linux-modules-5.15.0-051500rc1-generic_5.15.0-051500rc1.202109122030_arm64.deb
      sudo dpkg -i *.deb
      cd
      rm -r /tmp/ubuntukernel$KERNEL_VER
      break
