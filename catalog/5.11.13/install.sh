...
while [[ $# -gt 0 ]]; do
  ...
  case "${1}" in
    ...
    -arm|--arm64)
      mkdir /tmp/ubuntukernel$KERNEL_VER
      cd /tmp/ubuntukernel$KERNEL_VER
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.13/arm64/linux-headers-5.11.13-051113-generic_5.11.13-051113.202104101231_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.13/arm64/linux-image-unsigned-5.11.13-051113-generic_5.11.13-051113.202104101231_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.11.13/arm64/linux-modules-5.11.13-051113-generic_5.11.13-051113.202104101231_arm64.deb
      sudo dpkg -i *.deb
      cd
      rm -r /tmp/ubuntukernel$KERNEL_VER
      break
