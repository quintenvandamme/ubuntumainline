...
while [[ $# -gt 0 ]]; do
  ...
  case "${1}" in
    ...
    -arm|--arm64)
      mkdir /tmp/ubuntukernel$KERNEL_VER
      cd /tmp/ubuntukernel$KERNEL_VER
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.19/arm64/linux-headers-5.12.19-051219-generic_5.12.19-051219.202107201136_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.19/arm64/linux-image-unsigned-5.12.19-051219-generic_5.12.19-051219.202107201136_arm64.deb
      wget https://kernel.ubuntu.com/~kernel-ppa/mainline/v5.12.19/amd64/linux-modules-5.12.19-051219-generic_5.12.19-051219.202107201136_amd64.deb
      sudo dpkg -i *.deb
      cd
      rm -r /tmp/ubuntukernel$KERNEL_VER
